#ifndef __VELOCITY_BUFFER_READ_STENCIL_H__
#define __VELOCITY_BUFFER_READ_STENCIL_H__
...
class VelocityBufferReadStencil : public BoundaryStencil<FlowField> {
	...
	VelocityBufferReadStencil (const Parameters & parameters, FLOAT *bufferLeftWall, FLOAT *bufferRightWall, FLOAT *bufferTopWall, FLOAT *bufferBottomWall, FLOAT *bufferFrontWall, FLOAT *bufferBackWall);
