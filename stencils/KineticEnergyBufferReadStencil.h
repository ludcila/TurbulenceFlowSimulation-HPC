#ifndef __KINETICENERGY_BUFFER_READ_STENCIL_H__
#define __KINETICENERGY_BUFFER_READ_STENCIL_H__

#include "../Stencil.h"
#include "../TurbulentFlowField.h"

class KineticEnergyBufferReadStencil : public BoundaryStencil<TurbulentFlowField> {
	...
	KineticEnergyBufferReadStencil (const Parameters & parameters, FLOAT *bufferLeftWall, FLOAT *bufferRightWall, FLOAT *bufferTopWall, FLOAT *bufferBottomWall, FLOAT *bufferFrontWall, FLOAT *bufferBackWall);
