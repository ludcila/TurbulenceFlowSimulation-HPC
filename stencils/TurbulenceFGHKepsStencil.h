#ifndef _TURBULENCE_KEPS_STENCIL_FGH_H_
#define _TURBULENCE_KEPS_STENCIL_FGH_H_
...
class TurbulenceFGHKepsStencil : public FieldStencil<TurbulentFlowField>
{
    ...
    public:
        //constructor
        TurbulenceFGHKepsStencil ( const Parameters & parameters );
        //apply methods
