#ifndef __DISSIPATIONRATE_BUFFER_FILL_STENCIL_H__
#define __DISSIPATIONRATE_BUFFER_FILL_STENCIL_H__

#include "../Stencil.h"
#include "../TurbulentFlowField.h"

class DissipationRateBufferFillStencil : public BoundaryStencil<TurbulentFlowField> {
	...
	DissipationRateBufferFillStencil (const Parameters & parameters, FLOAT *bufferLeftWall, FLOAT *bufferRightWall, FLOAT *bufferTopWall, FLOAT *bufferBottomWall, FLOAT *bufferFrontWall, FLOAT *bufferBackWall);
